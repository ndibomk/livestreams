...
function JoinScreen({ getMeetingAndToken, setMode }) {
  ...
  return (
    <div className="container">
      <button onClick={() => onClick("CONFERENCE")}>Create a livestream</button>
      <br />
      <br />
      {" or "}
      <br />
...
function Controls() {
  ...
  return (
    <div>
      ...
      <button onClick={() => toggleWebcam()}>Turn off Webcam</button>
      &emsp;|&emsp;
      <button
        onClick={() => {
          startHls({
      ...
      <button onClick={() => stopHls()}>Stop streaming</button>
    </div>
  );
}
